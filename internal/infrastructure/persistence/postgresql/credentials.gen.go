...
func newCredential(db *gorm.DB, opts ...gen.DOOption) credential {
	...
	_credential.UserID = field.NewString(tableName, "user_id")
	_credential.Type = field.NewString(tableName, "type")
	_credential.SecretData = field.NewField(tableName, "secret_data")
	_credential.CredentialData = field.NewField(tableName, "credential_data")
...
type credential struct {
	...
	UserID         field.String
	Type           field.String
	SecretData     field.Field
	CredentialData field.Field
...
func (c *credential) updateTableName(table string) *credential {
	...
	c.SecretData = field.NewField(table, "secret_data")
	c.CredentialData = field.NewField(table, "credential_data")
...
func (c *credential) fillFieldMap() {
	...
	c.fieldMap["secret_data"] = c.SecretData
	c.fieldMap["credential_data"] = c.CredentialData
